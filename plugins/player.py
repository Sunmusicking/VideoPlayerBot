...
async def not_chat(_, m: Message):
    ...
    await m.reply_photo(photo=Config.THUMB_LINK, caption="**Sorry, You Can't Use This Bot In This Group 🤷‍♂️! But You Can Make Your Own Bot Like This From The [Source Code](https://t.me/iMzaynKING) Below 😉!**", reply_markup=InlineKeyboardMarkup(buttons))
